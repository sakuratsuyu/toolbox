...
def add_file_output(render_layers, nodes, links):
    ...
    material_index_file_output = nodes.new(type="CompositorNodeOutputFile")
    material_index_file_output.name = "material_index_output"
    material_index_file_output.format.file_format = "OPEN_EXR"
    material_index_link = links.new(render_layers.outputs["IndexMA"], material_index_file_output.inputs[0])
    material_index_file_output.base_path = save_path
    material_index_file_output.file_slots[0].path = "material_index_"
    ...
    gbuffer_links = [alpha_link, depth_link, normal_link, position_link, material_index_link]
    gbuffer_outputs = [alpha_file_output, depth_file_output, normal_file_output, position_file_output, material_index_file_output]
